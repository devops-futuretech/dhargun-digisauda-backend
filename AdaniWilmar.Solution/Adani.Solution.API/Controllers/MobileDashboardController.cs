...
namespace Adani.Solution.API.Controllers
{
    ...
    {
        private const string ServiceName = "MobileDashboard Controller";
        private readonly ILogger _logger = Logging.GetLogger(ServiceName);
        private readonly IMobileDashboardServices _mobileDashboardServices;
        private string _methodName;

        public MobileDashboardController(IMobileDashboardServices mobileDashboardServices) : base(ServiceName)
        {
        ...
        public IHttpActionResult DashboardPackwiseSaleslist([FromBody]string inputKey)
        {
            ...
            return Result(inputKey, _methodName, (DashboardOverallSaudaInputDto x) => { return _mobileDashboardServices.DashboardPackwiseSaleslist(x); });
        }
        [HttpPost]
        ...
        public IHttpActionResult BDOPlantDepotDetailsByDealer([FromBody]string inputKey)
        {
            ...
            return Result(inputKey, _methodName, (LoginUserIdDto x) => { return _mobileDashboardServices.BDOPlantDepotDetailsByDealer(x); });
        }
        ...
        [HttpPost]
        [Route("quantityallocation/list")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "GetDailySFQuantityAllocation", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult GetDailySFQuantityAllocation([FromBody]string inputKey)
        {
            _methodName = "GetDailySFQuantityAllocation";
            return Result(inputKey, _methodName, (QuantityAllocationInputDto x) => { return _mobileDashboardServices.GetDailySFQuantityAllocation(x); });
        }
        ...
        public IHttpActionResult DailyBookedSaudaReport([FromBody]string inputKey)
        {
            ...
            return Result(inputKey, _methodName, (DailyBookedSaudaInputDto x) => { return _mobileDashboardServices.DailyBookedSaudaReport(x); });
        }
        [HttpPost]
        ...
        public IHttpActionResult SalesReport([FromBody]string inputKey)
        {
            ...
            return Result(inputKey, _methodName, (DailyBookedSaudaInputDto x) => { return _mobileDashboardServices.SalesReport(x); });
        }
        [HttpPost]
        [Route("dailyrate/manager")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "GetDailyRateForManager", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult GetDailyRateForManager([FromBody]string inputKey)
        {
            _methodName = "GetDailyRateForManager";
            return Result(inputKey, _methodName, (DailyRateInputDto x) => { return _mobileDashboardServices.GetDailyRateForManager(x); });
        }


        [HttpPost]
        [Route("Invoice/InvoiceDetailsByDealers")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "InvoiceDetailsByDealer", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult InvoiceDetailsByDealer([FromBody]string inputKey)
        {
            _methodName = "InvoiceDetailsByDealer";
            return Result(inputKey, _methodName, (IdInputDto x) => { return _mobileDashboardServices.InvoiceDetailsByDealer(x); });
        }
        ...
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "GetDailyRate", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult GetDailyRate1(DailyRateInputDto inputKey)
        {
            _methodName = "GetDailyRate";
            // return Result(inputKey, _methodName, (DailyRateInputDto x) => { return _mobileDashboardServices.GetDailyRate(x); });
            var result = new ResultDto();
            result = _mobileDashboardServices.GetDailyRate(inputKey);
            return Ok(result);
        }
        [HttpPost]
        [Route("DueForTomorrowList1")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "DueForTomorrowList", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult DueForTomorrowList1(LoginUserIdDto inputKey)
        {
            _methodName = "DueForTomorrowList";
            var result = new ResultDto();
            //return Result(inputKey, _methodName, (LoginUserIdDto x) => { return _mobileDashboardServices.DueForTomorrowList(x); });
            result = _mobileDashboardServices.DueForTomorrowList(inputKey);
            return Ok(result);
        }
        [HttpPost]
        [Route("packgroupwise/sales1")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "DashboardPackwiseSaleslist", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult DashboardPackwiseSaleslist1(DashboardOverallSaudaInputDto inputKey)
        {
            _methodName = "DashboardPackwiseSaleslist";
            //return Result(inputKey, _methodName, (DashboardOverallSaudaInputDto x) => { return _mobileDashboardServices.DashboardPackwiseSaleslist(x); });
            var result = new ResultDto();
            result = _mobileDashboardServices.DashboardPackwiseSaleslist(inputKey);
            return Ok(result);
        }

        [HttpPost]
        [Route("packgroupwise/invoicesByDealers1")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "PackwiseInvoicesByDealer", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult PackwiseInvoicesByDealer1(DashboardSaudaDetailsByDealersInputDto inputKey)
        {
            _methodName = "PackwiseInvoicesByDealer";
            //return Result(inputKey, _methodName, (DashboardSaudaDetailsByDealersInputDto x) => { return _mobileDashboardServices.PackwiseInvoicesByDealer(x); });
            var result = new ResultDto();
            result = _mobileDashboardServices.PackwiseInvoicesByDealer(inputKey);
            return Ok(result);
        }

        [HttpPost]
        [Route("packgroupwise/InvoiceDetailsByDealers1")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "PackwiseInvoiceDetailsByDealer", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult PackwiseInvoiceDetailsByDealer1(IdInputDto inputKey)
        {
            _methodName = "PackwiseInvoiceDetailsByDealer";
            //return Result(inputKey, _methodName, (IdInputDto x) => { return _mobileDashboardServices.PackwiseInvoiceDetailsByDealer(x); });
            var result = new ResultDto();
            result = _mobileDashboardServices.PackwiseInvoiceDetailsByDealer(inputKey);
            return Ok(result);
        }
        [HttpPost]
        [Route("dealer/salesorder")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "GetSalesOrderDetails", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult GetSalesOrderDetails([FromBody] string inputKey)
        {
            _methodName = "GetSalesOrderDetails";
            return Result(inputKey, _methodName, (IdInputDto x) => { return _mobileDashboardServices.GetSalesOrderDetails(x); });
        }
        [HttpPost]
        [Route("dealer/updatesalesorder")]
        [ResponseType(typeof(ContentDto))]
        [Throttle(Name = "UpdateSalesOrderDetails", Message = "The request has been declined for security reasons.", Seconds = 1)]
        public IHttpActionResult UpdateSalesOrderDetails([FromBody] string inputKey)
        {
            _methodName = "UpdateSalesOrderDetails";
            return Result(inputKey, _methodName, (LiftingUpdateDto x) => { return _mobileDashboardServices.UpdateSalesOrderDetails(x); });
        }
    }
}
