...
{
    public class RequestDisocuntDto : LoginUserIdDto
    {
    ...
    public class RequestDisocuntUpdateDto : LoginUserIdDto
    {
        public long Id { get; set; }        
        public decimal RequestedDiscount { get; set; }
        public bool PostStatus { get; set; }
    ...
    public class ApproveRequestDiscountDto : LoginUserIdDto
    {
        public long Id { get; set; }
