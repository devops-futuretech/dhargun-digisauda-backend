...
{
   public class TradeTicketExportDto
    {
        ...
        public List<SaudaOrderViewDto> TradeTicketDetailList { get; set; }

        public TradeTicketExportDto()
        {
            TradeTicketDetailList = new List<SaudaOrderViewDto>();
        }
    }
}
