IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'SP_Emami_DetentionCostReport')
    BEGIN
        DROP  Procedure SP_Emami_DetentionCostReport
    END
 Go
SET ANSI_NULLS ON
GO
...
GO
CREATE Procedure SP_Emami_DetentionCostReport
(
...
Begin
	...
	From DetentionCosts DC With(NoLock)
	...
	Inner Join States s With(NoLock) On D.StateId = s.Id
