USE [AdaniDb]
GO
/****** Object:  StoredProcedure [dbo].[ZH_GetOverallSales]    Script Date: 3/5/2024 12:54:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

Create or ALTER  PROCEDURE [dbo].[ZH_GetOverallSauda]
(	
	@UserId bigint,
...
select SalesOrganizationId,DistributionChannelId,DivisionId from UserDivisionMappings with(NOLOCK) where UserId=@UserId
 ...
 and so.StatusId in (Select * from dbo.Split(@Status,','))
   drop table #BdoTemp
